...
class Ui_ConvertWindow(object):
    def setupUi(self, ConvertWindow):
        ...
        ConvertWindow.setStyleSheet("font: 8pt \"Roboto\";")
        ...
        self.label_judul.setStyleSheet("font: 700 Bold 11pt \"Ubuntu\";")
    ...
    def retranslateUi(self, ConvertWindow):
        ...
        self.lokasiSumber_treeWidget.headerItem().setText(2, _translate("ConvertWindow", "Type"))
        ...
        self.lokasiTujuan_treeWidget.headerItem().setText(0, _translate("ConvertWindow", "Name"))
        self.lokasiTujuan_treeWidget.headerItem().setText(1, _translate("ConvertWindow", "Date Modified"))
        self.lokasiTujuan_treeWidget.headerItem().setText(2, _translate("ConvertWindow", "Type"))
